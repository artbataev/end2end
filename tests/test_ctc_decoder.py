...
class TestCTCDecoder(unittest.TestCase):
    ...
    def test_with_probs_sm(self):
        labels = ["_", "a"]
        decoder = CTCDecoder(beam_width=20, after_logsoftmax=True, blank_idx=0, time_major=False, labels=labels,
                             wip=0.0)
        probs_seq1 = [
            [0.7, 0.3],
            [0.7, 0.3],
    ...
    def test_with_probs_1(self):
        ...
        """
        labels = ["\'", ' ', 'a', 'b', 'c', 'd', '_']
        decoder = CTCDecoder(beam_width=20, after_logsoftmax=True, blank_idx=6, time_major=False, labels=labels,
                             wip=0.0)
        probs_seq = [[
    ...
    def test_with_probs_2(self):
        ...
        """
        labels = ["\'", ' ', 'a', 'b', 'c', 'd', '_']
        decoder = CTCDecoder(beam_width=20, after_logsoftmax=True, blank_idx=6,
                             time_major=False, labels=labels, wip=0.0)
        probs_seq = [[
